...
- files for PRS plus PC for Afr. ind., read into R, merge with phenotype data frame and then run linear regr looking at effects of each polygenic risk score on depr., extract info and put into tables  
